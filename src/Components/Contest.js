...
function Contest(props) {
    ...
    return (
        <div className="p-4 md:w-1/3">
            <div className="flex rounded-lg h-full bg-stone-900 bg-opacity-60 p-8 flex-col">
                <div className="flex items-center mb-3">
                    ...
                    <a href={props.data.url}>
                        <h2 className="text-white text-lg title-font font-medium hover:underline">{props.data.name}</h2>
                    </a>
                </div>
                <div className="flex-grow text-center">
                    <div className="leading-relaxed text-2xl text-green-500">{props.data.site}</div>
